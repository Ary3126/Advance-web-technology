...
function Contact() {
  // useState Hook 1: Controlled form inputs
  const [name, setName] = useState('')
  const [email, setEmail] = useState('')
  const [message, setMessage] = useState('')

  // useState Hook 2: UI Visibility toggle (Help Tooltip)
  const [showHelp, setShowHelp] = useState(false)

  // useState Hook 3: Form submission feedback message
    ...
    <div className="contact-page main-content">
      <div className="contact-container">
        ...
        <section className="contact-card">
          ...
          {/* UI Visibility Toggle: Help Tooltip */}
          {showHelp && (
              ...
              <div className="form-group">
                ...
                <div className="textarea-wrapper">
                  <textarea
                    ...
                    required
                  />
                  {/* Supplementary Requirement: Live Character Count */}
                  <div
        ...
        {/* Real-time Controlled Input Preview Card */}
        <section className="preview-card">
          <span className="live-badge">⚡ Real-Time Live Preview</span>
          <h3>Form Input State</h3>
          <p>This box demonstrates reactive state updates using React&apos;s <code>useState</code> hook.</p>
